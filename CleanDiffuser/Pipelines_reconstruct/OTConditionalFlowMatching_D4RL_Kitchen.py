...
from flow import ConditionalFlowMatchingAgent, ExactOptimalTransportConditionalFlowMatchingAgent
...
def pipeline(args):
    ...
    # --------------- Diffusion Model --------------------
    agent = ExactOptimalTransportConditionalFlowMatchingAgent(
        nn_diffusion, None,
